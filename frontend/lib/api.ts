import type { ApiEnvelope, PriceAlert, Product, Trend } from './types';
...
export const api = {
  ...
  alert: (productId: number, target: number, dropPercent = 10) => request<PriceAlert>('/alerts', { method: 'POST', body: JSON.stringify({ product_id: productId, target_price: target, drop_percent: dropPercent }) }),
